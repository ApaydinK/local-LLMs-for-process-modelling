        ...
        response = ollama.chat(model='llama3', messages=[
            {
                ...
                'content': f'The operators used in a proces tree are: ->(...) sequence, X(...) choice, +(...) parallel, *(...) loop. '
                           ...
                           f'\n'
                           f'When this model is played out or simulated then the following instances are are observed: '
                           f'{playout}'
                           f'Make sure that your process description matches the simulated instances, '
                           f'i.e. all simulated instances should be possible for following your description of the process'
                ,
            },
        ])
        # print( response['message']['content'])
